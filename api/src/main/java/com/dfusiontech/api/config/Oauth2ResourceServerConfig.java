...
import com.dfusiontech.server.http.CORSPermissiveFilter;
import com.dfusiontech.server.http.DownloadAuthorizationFilter;
import com.dfusiontech.server.http.JsonToUrlEncodedAuthenticationFilter;
...
public class Oauth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	/**
	 * Configure OAuth vrisk security configuration
	 *
	 * @param http
	 * @throws Exception
	 */
